...
def init_argparser():
    ...
    """
    parser = ArgParse()
    parser.add_argument('abstract_file', type=str, suggest_suffix='.csv',
                        help='the path to the abstract file generated by import_biblio.py',
                        input=True)
...
def prepare_papers(abstract_path, json_path):
    """
    Extracts all necessary data for each paper in the biblio file and the json file to create
    a list of dictionaries containing all grouped data.

    :param abstract_path: path to the biblio file containing papers data
